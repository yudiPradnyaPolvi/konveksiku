<footer class="  bg-gray-800 rounded-lg shadow sm:flex flex-col sm:items-center sm:justify-center p-4 sm:p-6 xl:p-8 dark:bg-gray-800 antialiased">
    <p class="mb-4 text-sm text-center text-gray-300 dark:text-gray-400 sm:mb-0">
        &copy; 2024 <a href="https://flowbite.com/" class="hover:underline" target="_blank">Konveksi Ku</a> | All rights reserved
    </p>
